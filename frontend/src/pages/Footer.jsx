...
const Footer = () => {
  return (
    <footer className="pt-10 w-full h-auto bg-gray-700 sm:flex sm:flex-row ">
      <div className="w-full px-8 max-w-7xl">
        <div className="grid  grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div className="grid  grid-cols-2 gap-4 text-white mb-5">
            <ul>
              <p className="font-bold tracking-wide mb-2" >Company</p>
              <li>
            ...
            <ul>
              <p className="font-bold tracking-wide mb-2">Contact us</p>
              <li>
              <Link to="/">Team</Link>
              </li>
              <li>
